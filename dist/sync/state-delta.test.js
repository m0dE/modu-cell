...
import { computeStateDelta, computeSnapshotHash, serializeDelta, deserializeDelta, getPartition, getEntityPartition, deserializePartition, assemblePartitions, isDeltaEmpty, getDeltaSize } from './state-delta';
// Helper to create mock snapshots for testing
function createMockSnapshot(entities, frame = 0) {
